...
license: "MIT"
metadata: {"version":"1.2.13","author":"UIZZE <business@uizze.com>","compatibility":"Designed for Claude Code, Codex, Cursor, and GitHub Copilot; works in any agent that can read project files and fetch a URL.","tags":"ui-design, design-system, design-review, frontend, web-ui, ios-ui"}
---
